...
public class Question2_1 {
    ...
    private static class StringAndInt implements Comparable<StringAndInt>, Writable {
        ...
        public int compareTo(StringAndInt stringAndInt) {
            return occurence.compareTo(stringAndInt.occurence);
        }
    ...
    public static class TopTagsFlickrByCountryMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    public static class TopTagsFlickrByCountryReducer extends Reducer<Text, Text, Text, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            for (Text value : values)
                tagFrequencyMap.merge(value.toString(), 1, Integer::sum);
